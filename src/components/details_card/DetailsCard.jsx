...
const DetailsCard = ({ id, title, year, genre=[], cast=[], synopsis, img }) => {
    return (
        <div className="w-full flex item-center justify-center my-8" key={id}>
            <div className="flex flex-col items-center w-5/6 bg-white border border-gray-200 rounded-lg shadow-sm md:flex-row md:container dark:border-gray-700 dark:bg-gray-800">
